...
<body>
  ...
  <section class="vh-100" style="background-color:#ff6347 ;">
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form action="login.php" method="post">
                    ...
                    <div class="d-flex align-items-center justify-content-center mb-5 pb-1">
                      ...
                      <span class="text-center text-primary h1 fw-bold mb-0 center">Login</span>
                    </div>
                    ...
                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="registration.php" class="text-primary " >Register here</a></p>
